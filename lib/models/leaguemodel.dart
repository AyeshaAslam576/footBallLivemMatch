import 'dart:convert';
LeagueModel compitionModelFromJson(String str) => LeagueModel.fromJson(json.decode(str));
String compitionModelToJson(LeagueModel data) => json.encode(data.toJson());
class LeagueModel {
  LeagueModel({
      this.countryId, 
      this.countryName, 
